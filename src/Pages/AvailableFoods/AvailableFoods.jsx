...
const AvailableFoods = () => {
    ...
    if (searchText !== null && searchText !== '' && searchText !== 'all') {
        fetchData = fetchData?.filter(data => {
    ...
    // If no sort value is provided, retain the search order
    if (!sortValue) {
    ...
    return (
        <div className="bg-base-200">
            <div className="py-[50px] max-w-[1240px] mx-auto ">
                <Helmet>
                ...
                </div>
                {
                    fetchData.length > 0 ?
                        ...
                        : <><div><p className="text-center text-[60px] my-[100px]">No matching data found</p></div></>
                }
                <div className="flex justify-center">
